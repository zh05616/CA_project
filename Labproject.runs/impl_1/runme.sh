...
HD_PWD='C:/Users/aa05432/Downloads/CAProject (2)/CAProject/Labproject/Labproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_V_Processor.tcl -notrace
